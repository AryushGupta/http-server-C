...
| Usually initiates communication | Usually waits for communication |
| Requests resources/services | Provides resources/services |
| Browser is an example | Web server is an example |
| Postman is an example | API server is an example |
| Usually interacts with the user | Usually works in the background |
